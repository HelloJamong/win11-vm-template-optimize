...
- `README.md` 사용 흐름 및 참고 문서 안내 정리
  - 6. 사용 흐름의 VDI compact 단계에서 `VBoxManage` 언급 제거
  - 8. 참고 프로젝트 및 라이선스 섹션을 `NOTICE.md` 링크 안내로 간소화

### Removed

- `README.md` 9. 향후 계획 섹션 삭제

### Verification

- `README.md` 내 `VBoxManage` 참조 제거 확인
- `README.md` 내 `## 9. 향후 계획` 섹션 삭제 확인
- `README.md` 내 `NOTICE.md` 링크 유지 확인
