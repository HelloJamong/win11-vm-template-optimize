...
- [ ] 전원 계획 및 절전/화면 꺼짐 타임아웃이 조직 기준에 맞다.
- [ ] 파일 탐색기가 This PC 기준으로 열리며 최근 항목 노출이 제한되어 있다.
- [ ] 시작 메뉴 추천/최근 항목이 제한되어 있다.
- [ ] Widgets/Task View/추천 알림이 조직 기준에 맞게 제한되어 있다.
- [ ] 잠금화면 Spotlight/팁/추천 콘텐츠가 제한되어 있다.
- [ ] 업무 앱 또는 보안 에이전트 UI/알림과 충돌하지 않는다.
